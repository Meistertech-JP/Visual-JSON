...
The Visual JSON name, logo, screenshots, demo GIFs, image assets, and project branding are not licensed under the MPL-2.0.

You may not use them to imply endorsement or to distribute a modified version as an official Visual JSON release.

## Third-Party Components

AvalonEdit is licensed separately under the MIT License. See [THIRD_PARTY_NOTICES.md](THIRD_PARTY_NOTICES.md).
