...
- **Standard test tooling.** All tests migrated from a custom console runner to MSTest with identical inputs and expectations; `dotnet test` (with TRX result files) is now the single entry point. The suite grew from 82 to 97 tests.
