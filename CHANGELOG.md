...
- Corrected `UT-P2-STA-006` to apply its 200ms requirement to the p95 of individual 10MB offset lookups instead of the aggregate time for 60 lookups, removing CI runner-speed sensitivity without relaxing the acceptance criterion.
